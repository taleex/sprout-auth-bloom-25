...
const defaultData: ChartCategoryData[] = [
  { key: 'Savings', data: 5000 },
  { key: 'Checking', data: 3200 },
  { key: 'Investment', data: 8500 },
  { key: 'Emergency', data: 2800 },
];
...
const defaultChartColors = ['#9152EE', '#40D3F4', '#40E5D1', '#4C86FF'];
...
}: IncidentSummaryCardProps): JSX.Element {
  // Validate and prepare chart data
  const validatedCategoryData = data.map(item => ({
    ...item,
